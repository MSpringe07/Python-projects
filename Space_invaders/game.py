...
stop_text_rect = stop_button_text.get_rect(center=stop_button_rect.center)
...
while running:
    ...
    screen.blit(stop_button_text, stop_text_rect)  # Center the text within the button

    # Draw options
    if show_options:
        pygame.draw.rect(screen, (128, 128, 128), resume_button_rect)
        pygame.draw.rect(screen, (128, 128, 128), exit_button_rect)
        screen.blit(resume_button_text, resume_text_rect)
